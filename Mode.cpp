...
//             {
//                 ///
//                 handle_i_flag(sign, ch, clients_map, fd, s, sign_str);
//                 ///
//                 i++;
//                 continue; //return;
//             }
//             else if (s[2][i] == 't') // flag t
//             {
//                 handle_t_flag(sign, ch, clients_map, fd, s, sign_str);
//                 i++;
//                 continue; //return;
//             }
//             else if (s[2][i] == 'k')  // flag k
//             {
//                 if (!handle_k_flag(sign, ch, clients_map, fd, s, sign_str, arg_idx))
//                     return;
//                 i++;
//                 continue; //return;
//             }
...
// /////
// void handle_i_flag(char sign, Channel &ch, std::map<int, Client> &clients_map, int fd, std::vector<std::string> &s, std::string sign_str)
// {
//     if (sign == '+')
//         ch.set_invite_only(true);
//     else if (sign == '-')
...
// void handle_t_flag(char sign, Channel &ch, std::map<int, Client> &clients_map, int fd, std::vector<std::string> &s, std::string sign_str)
// {
//     if (sign == '+')
//         ch.set_Topic_Restricted(true);
//     else if (sign == '-')
...
// bool handle_k_flag(char sign, Channel &ch, std::map<int, Client> &clients_map, int fd, std::vector<std::string> &s, std::string sign_str, int &arg_idx)
// {
//     std::string send_M;
//     if (sign == '+')
//     {
...
// void handle_o_flag(char sign, Channel &ch, std::map<int, Client> &clients_map, int fd, std::vector<std::string> &s, std::string sign_str)
// {
